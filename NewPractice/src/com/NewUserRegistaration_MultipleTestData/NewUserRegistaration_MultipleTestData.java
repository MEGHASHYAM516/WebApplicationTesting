package com.NewUserRegistaration_MultipleTestData;
...
public class NewUserRegistaration_MultipleTestData 
{
FirefoxDriver driver;
	...
	{
		FileInputStream file = new FileInputStream("C:\\Users\\MEGHASHYAM\\Desktop\\ShyamSelenium\\NewPractice\\src\\com\\UserRegistrationTestExcel\\URTDC.xlsx");
		...
		else
		{
			...
			r.createCell(12).setCellValue("User Registrations Failed -- FAIL");
		}
		
		FileOutputStream file1 = new FileOutputStream("C:\\Users\\MEGHASHYAM\\Desktop\\ShyamSelenium\\NewPractice\\src\\com\\UserRegistrationTestExcel\\UserRegistrationResult1.xlsx");
